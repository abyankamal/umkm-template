<div class="rounded overflow-hidden shadow-lg bg-white">
    <script>
        document.title = 'Manajemen Kategori Artikel';
    </script>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea wire:model.live="description" rows="5"
                            class="w-full px-2 py-1 border rounded-lg focus:outline-none focus:border-kutamis-purple" placeholder="Masukan Deskripsi Kategori"></textarea>
